...
@Component({
  selector: 'app-PEDIATRIC_UROLOGY&OPTICAL_URETHROTOME',
  templateUrl: './PEDIATRIC_UROLOGY&OPTICAL_URETHROTOME.component.html',
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'Asset Inspection Card - PEDIATRIC UROLOGY & OPTICAL URETHROTOME', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
        ...
        { text: 'VISUAL INSPECTION OF THE ELECTRO SURGICAL GENERATOR AND ACCESSORIES', fontSize: 12 },
        {
          table: {
            ...
            body: [
              ...
              ['4', 'OBSTRUCTION & DAMAGE ', 'NONE PESENT', `${s4}`],
...

        {
          table: {
            ...
            body: [
              ...
              ['5', 'HANDLE OPERATION (A3550 & A37914A ONLY)', 'PROCEDURE PASSED', `${s5}`],
              ['6', 'STOPCLOCK', ' PROCEDURE PASSED ', `${s6}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'PEDIATRIC_UROLOGY&OPTICAL_URETHROTOME_' + sno}`; // Custom file name
