...
@Component({
  selector: 'app-HF_CABLE',
  templateUrl: './HF_CABLE.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Hfcablecomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR HF CABLE', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['3', 'WORKING', 'PROCEDURE PASSED', `${s3}`],
              ['4', 'APPEARANCE', 'PROCEDURE PASSED', `${s4}`],
              ['5', 'CABLE', 'PROCEDURE PASSED', `${s5}`],
