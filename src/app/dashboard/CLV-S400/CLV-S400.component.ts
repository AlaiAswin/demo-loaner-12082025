...
@Component({
  selector: 'app-CLV-S400',
  templateUrl: './CLV-S400.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Clvs400Component {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR CLV-S400', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
      ...
      if (image_data_url) {
        content.unshift(
          { text: 'Issue date :  08 Aug 2018', alignment: 'right', fontSize: 5, }, { text: 'REV NO : 02', alignment: 'right', fontSize: 5 },
          {
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'CLV-S400_' + sno}`; // Custom file name
