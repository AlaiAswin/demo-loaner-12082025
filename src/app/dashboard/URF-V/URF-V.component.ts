...
@Component({
  selector: 'app-URF-V',
  templateUrl: './URF-V.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class UrfvComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR URF-V', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['9', 'Instrument channelsystem', 'Inspection of the instrument channel', `${s9}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'URF-V_' + sno}`; // Custom file name
