...
(pdfMake as any).vfs = pdfFonts;
@Component({
  selector: 'app-gf-uct180',
  templateUrl: './gf-uct180.component.html',
  styleUrls: ['./gf-uct180.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Gfuct180Component {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  constructor(
    private popupservice: PopUpService, private fb: FormBuilder, private router: Router, private renderer: Renderer2, private location: Location) {
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        if ((s1 == p) && (s2 == p) && (s3 == p) && (s4 == p) && (s5 == p) && (s6 == p) && (s7 == p) && (s8 == p) && (s9 == p) && (s10 == p) && (s11 == p) && (s12 == p) && (s13 == p) && (s14 == p) && (s15 == p) && (s16 == p) && (s17 == p) && (s18 == p) && (s19 == p) && (s20 == p) && (s21 == p)) {
          // console.log('Pass')
          overRes = 'Pass'
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR GF-UCT180', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['12', 'Endoscope connector', 'Connection of the endoscope and ultrasonic cable', `${s12}`],
                ['13', 'Image system', 'Inspection of the endoscopic image', `${s13}`],
                ['14', 'Ultrasound imaging system', 'Inspection of the ultrasound image with the Olympus universal endoscopic ultrasound center EU-ME1', `${s14}`],
                ...
                ['18', 'Balloon water supply system', 'Inspection of the water feeding function into the balloon', `${s18}`],
                ['19', 'Suction System', 'Inspection of the suction function', `${s19}`],
                ...(image_data_url === null ? [['', '', '', { text: '', pageBreak: 'before' }]] : []),
                ['20', 'Balloon water suction system', 'Inspection of aspiration from the balloon water suction port', `${s20}`],

                ['21', 'Instrument channel system;\nforceps elevator system', 'Inspection of the instrument channel and forceps elevator', `${s21}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'GF-UCT180_' + sno}`; // Custom file name
