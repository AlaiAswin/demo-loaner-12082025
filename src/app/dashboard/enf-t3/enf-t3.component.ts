...
@Component({
  selector: 'app-enf-t3',
  templateUrl: './enf-t3.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class EnfT3Component {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR ENF-T3', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['5', 'Light guide connector', 'Inspection of the endoscopic image by attaching to light source', `${s5}`],
                [
                  '6',
                  'Image system',
                  {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'ENF-T3_' + sno}`; // Custom file name
