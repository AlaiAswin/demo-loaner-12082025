...
@Component({
  selector: 'app-LEAKAGE_TESTER',
  templateUrl: './LEAKAGE_TESTER.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Leakagetestercomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR LEAKAGE TESTER', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['2', 'PRESSURE LOCK', 'PROCEDURE PASSED', `${s2}`],
              ['3', 'GAUGE METER', 'PROCEDURE PASSED', `${s3}`],
