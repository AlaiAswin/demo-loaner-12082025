...
@Component({
  selector: 'app-ESG-410',
  templateUrl: './ESG-410.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Esg410component {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'Asset Inspection Card - ESG-410', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            widths: [25, 125, 275, 75],
            body: [
              ['4', 'SELF TEST ESG-410 ', 'PROCEDURE PASSED', `${s4}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'ESG-410_' + sno}`; // Custom file name
