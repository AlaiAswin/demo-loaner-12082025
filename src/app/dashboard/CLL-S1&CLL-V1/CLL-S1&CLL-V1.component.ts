...
@Component({
  selector: 'app-CLL-S1&CLL-V1',
  templateUrl: './CLL-S1&CLL-V1.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Clls1ncllv1component {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'Asset Inspection Card - CLL-S1&CLL-V1', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['5', 'PUSH BUTTONS', 'PROCEDURE PASSED', `${s5}`],
              ['6', 'FOOT SWITCH CONNCTION(CLL-S1)', ' PROCEDURE PASSED', `${s6}`],
            ],
          }
        },
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'CLL-S1&CLL-V1_' + sno}`; // Custom file name
