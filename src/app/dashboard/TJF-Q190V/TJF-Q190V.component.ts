...
(pdfMake as any).vfs = pdfFonts.vfs;
@Component({
  selector: 'app-TJF-Q190V',
  templateUrl: './TJF-Q190V.component.html',
  styleUrls: ['./TJF-Q190V.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Tjfq190vComponent {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        if ((s1 == p) && (s2 == p) && (s3 == p) && (s4 == p) && (s5 == p) && (s6 == p) && (s7 == p) && (s8 == p) && (s9 == p) && (s10 == p) && (s12 == p) && (s13 == p) && (s14 == p) && (s15 == p) && (s16 == p) && (s17 == p)) {
          // console.log('Pass')
          overRes = 'Pass'
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR TJF-Q190V', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['11', 'Image system', 'Inspection of the endoscopic image', `${s12}`],
                ['12', 'Control section;\nSwitch system', 'Inspection of the remote switches', `${s13}`],
                ['13', 'Air supply system', 'Inspection of the air-feeding function', `${s14}`],
                ...
                ['15', 'Suction System', 'Inspection of the suction function', `${s16}`],
                ['16', 'Instrument channel system', 'Inspection of the instrument channel and forcep elevator', `${s17}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'TJF-Q190V_' + sno}`; // Custom file name
