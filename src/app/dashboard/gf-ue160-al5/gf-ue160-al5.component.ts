...
(pdfMake as any).vfs = pdfFonts.vfs;
@Component({
  selector: 'app-gf-ue160-al5',
  templateUrl: './gf-ue160-al5.component.html',
  styleUrls: ['./gf-ue160-al5.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Gfue160al5Component {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR GF-UE160-AL5', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'GF-UE160-AL5_' + sno}`; // Custom file name
