...
@Component({
  selector: 'app-TROCARS',
  templateUrl: './TROCARS.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Trocarscomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'Asset Inspection Card - TROCARS', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['5', 'STOPCOCK/VALES', 'PROCEDURE PASSED ', `${s5}`],
              ['6', 'SPIKE', ' PROCEDURE PASSED ', `${s6}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'TROCARS_' + sno}`; // Custom file name
