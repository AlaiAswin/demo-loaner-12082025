...
(pdfMake as any).vfs = pdfFonts.vfs;
@Component({
  selector: 'app-TJF-Q150',
  templateUrl: './TJF-Q150.component.html',
  styleUrls: ['./TJF-Q150.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Tjfq150Component {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR TJF-Q150', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'TJF-Q150_' + sno}`; // Custom file name
