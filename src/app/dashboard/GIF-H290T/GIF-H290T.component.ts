...
(pdfMake as any).vfs = pdfFonts.vfs;
@Component({
  selector: 'app-GIF-H290T',
  templateUrl: './GIF-H290T.component.html',
  styleUrls: ['./GIF-H290T.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Gifh290tComponent {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        if ((s1 == p) && (s2 == p) && (s3 == p) && (s4 == p) && (s5 == p) && (s6 == p) && (s7 == p) && (s8 == p) && (s9 == p) && (s10 == p) && (s11 == p) && (s12 == p) && (s13 == p) && (s14 == p) && (s15 == p) && (s16 == p) && (s17 == p) && (s18 == p)) {
          // console.log('Pass')
          overRes = 'Pass'
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR GIF-H290T', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['8', 'Endoscope connector;\nAuxiliary water inlet cap', 'Attaching the auxiliary water inlet cap', `${s8}`],
                ...
                ['12', 'Image system', 'Inspection of Zoom Function', `${s12}`],
        ...
        if (image_data_url) {
          content.unshift(
            { text: 'Issue date : 06 Sep 2023', alignment: 'right', fontSize: 5, }, { text: 'REV NO : 00', alignment: 'right', fontSize: 5 },
            {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'GIF-H290T' + sno}`; // Custom file name
