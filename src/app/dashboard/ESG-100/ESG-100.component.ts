...
@Component({
  selector: 'app-ESG-100',
  templateUrl: './ESG-100.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Esg100component {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'Asset Inspection Card - ESG-100', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['5', 'SOUND CHECK', 'PROCEDURE PASSED', `${s5}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'ESG-100_' + sno}`; // Custom file name
