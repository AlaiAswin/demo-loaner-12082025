...
export class PCFH190TLComponent {
  ...
  ngOnInit() {
    ...
    var s_time = new Date();
    this.startTime = s_time.toLocaleString("en-US", {
      hour: "numeric",
      minute: "numeric",
      hour12: true,
    });
  ...
  async download() {
    ...
    if (this.formGroup.status == "INVALID") {
      ...
      if (proceed == "true") {
        ...
        var f_time = new Date();
        this.endTime = f_time.toLocaleString("en-US", {
          hour: "numeric",
          minute: "numeric",
          hour12: true,
        });
        ...
        var content: Content[] = [
          {
            text: "DEMO-LOANER INSPECTION SHEET FOR PCF-H190TL",
            alignment: "center",
            margin: [0, 10, 0, 5],
            bold: true,
            fontSize: 16,
          ...
          },
          {
            table: {
              ...
              body: [
                [
                  { text: "S.N", fillColor: "#CCCCCC", alignment: "center" },
                  {
                  ...
                  {
                    text: "INSPECTION STANDARD",
                    fillColor: "#CCCCCC",
                    alignment: "center",
                  },
                  {
                    text: "INSEPECTION RESULT",
                    alignment: "center",
                    fillColor: "#CCCCCC",
                  },
                ],
                [
                  "1",
                  "Endoscope water tightness condition",
                  "Perform the leakage test (Check for 30 seconds)",
                  `${s1}`,
                ],
                [
                  "2",
                  "Brush Passage",
                  "Channel cleaning brush passage",
                  `${s2}`,
                ],
                [
                  "3",
                ...
                [
                  "6",
                  "Control section;\nAngle section",
                  "Inspection of the bending mechanisms:\n1. Inspection for smooth operation\n2. Inspection of the UP/DOWN/RIGHT/LEFT angulation mechanism",
                  `${s6}`,
                ],
                [
                  "7",
                  "Control section;\nSuction valve mounting section",
                  "Attaching the suction valve",
                  `${s7}`,
                ],
                [
                  "8",
                  "Control section;\nAir/water valve mounting section",
                  "Attaching the air/water valve",
                  `${s8}`,
                ],
                [
                  "9",
                  "Control section;\nBiopsy valve mounting section",
                ...
                [
                  "13",
                  "Insertion section",
                  "Inspection of the endoscope position detecting function (UPD function check)",
                  `${s13}`,
                ],
                [
                  "14",
                ...
                [
                  "15",
                  "Air supply system",
                  "Inspection of the air-feeding function:1. Confirmation of emitting no air bubbles\n2. Confirmation of emitting air bubbles",
                  `${s15}`,
                ],
                ...(image_data_url !== null
            ...
            table: {
              ...
              body: [
                [
                  ...
                  { text: `${this.startDate}` },
                  { text: "INSPECTION BY", fillColor: "#CCCCCC" },
                  { text: `${data["insBy"]}`, alignment: "center" },
                ],
                [
                  {
                    text: "START TIME",
                  ...
                  `${this.startTime}`,
                  { text: "FINAL RESULT", fillColor: "#CCCCCC", rowSpan: 2 },
                  { text: `${overRes}`, rowSpan: 2, alignment: "center" },
                ],
                [
                  {
                    text: "END TIME",
          ...
          {
            text: "*This is an electronically generated report, hence does not require a signature",
            fontSize: 6,
          },
        ];
        ...
        if (image_data_url) {
          content.unshift(
            {
              text: "Issue date : 05 Sep 2022",
              alignment: "right",
              fontSize: 5,
            },
            { text: "REV NO : 03", alignment: "right", fontSize: 5 },
            {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${"PCF-H190TL_" + sno}`; // Custom file name
