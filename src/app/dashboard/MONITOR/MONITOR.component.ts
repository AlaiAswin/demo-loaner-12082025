  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR MONITOR', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['2', 'MAIN SWITCH', 'PROCEDURE PASSED', `${s2}`],
              ['3', 'SCREEN (OUTPUT IMAGE)', 'PROCEDURE PASSED', `${s3}`],
              ['4', 'FUNCTIONS', 'PROCEDURE PASSED', `${s4}`],
              ['5', 'CONDITION OF APPEARANCE', 'PROCEDURE PASSED', `${s5}`],
