...
@Component({
  selector: 'app-chf-v2',
  templateUrl: './chf-v2.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Chfv2Component {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR CHF-V2', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['9', 'Endoscopic system', 'Inspection of the water irrigation', `${s9}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'CHF-V2_' + sno}`; // Custom file name
