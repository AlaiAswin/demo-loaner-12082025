...
(pdfMake as any).vfs = pdfFonts;
@Component({
  selector: 'app-gif-ez1500',
  templateUrl: './gif-ez1500.component.html',
  styleUrls: ['./gif-ez1500.component.css'],
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR GIF-EZ1500', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'GIF-EZ1500_' + sno}`; // Custom file name
