...
(pdfMake as any).vfs = pdfFonts;
@Component({
  selector: 'app-gif-lv1',
  templateUrl: './gif-lv1.component.html',
  styleUrls: ['./gif-lv1.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Giflv1Component {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR GIF-LV1', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['8', 'Endoscope connector', 'Connection to the video system centre', `${s8}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'GIF-LV1_' + sno}`; // Custom file name
