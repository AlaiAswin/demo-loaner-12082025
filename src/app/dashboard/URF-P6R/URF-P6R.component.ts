...
@Component({
  selector: 'app-URF-P6R',
  templateUrl: './URF-P6R.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Urfp6rComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR URF-P6R', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['5', 'Instrument channel system', 'Inspection of the instrument channel', `${s3}`],
              ],
            }
          },
          {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'URF-P6R_' + sno}`; // Custom file name
