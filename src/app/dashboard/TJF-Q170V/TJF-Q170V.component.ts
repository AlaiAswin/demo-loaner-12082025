...
(pdfMake as any).vfs = pdfFonts.vfs;
@Component({
  selector: 'app-TJF-Q170V',
  templateUrl: './TJF-Q170V.component.html',
  styleUrls: ['./TJF-Q170V.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Tjfq170vComponent {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR TJF-Q170V', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['6', 'Image system', 'Inspection of the endoscopic image', `${s6}`],
                ['7', 'Control section;\nSwitch system', 'Inspection of the remote switches', `${s7}`],
                ['8', 'Air supply system', 'Inspection of the air-feeding function', `${s8}`],
                ['9', 'Water supply system', 'Inspection of the objective lens cleaning function:\n1. Inspection of the water feeding function\n2. Inspection of removing the remaining water from the objective lens', `${s9}`],
                ['10', 'Suction System', 'Inspection of the suction function', `${s10}`],
                ['11', '1 Instrument channel System (ZEP10001)', 'Inspection of the instrunment channel', `${s11}`],
                ['12', 'Instrument channel system (ZEP10002)', 'Inspection of the instrument channel   forceps elevator.', `${s12}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'TJF-Q170V_' + sno}`; // Custom file name
