...
@Component({
  selector: 'app-bf-H1100',
  templateUrl: './bf-H1100.component.html',
  imports:[FormsModule,ReactiveFormsModule,CommonModule],
  standalone:true
})
export class  BfH1100Component{
  startTime:any;
  endTime:any;
  cdsDate:any;
  ...
  if(this.formGroup.status=='INVALID'){
    ...
    var content:Content[] = [
      ...
      {text: 'DEMO-LOANER INSPECTION SHEET FOR BF-H1100',alignment: 'center',margin:[0,10,0,5] ,bold:true,fontSize:16   },
       {
       table: {
...
const pdfDocGenerator = pdfMake.createPdf(dd);
    ...
    pdfDocGenerator.getBlob((blob) => {
      const fileName = `${'BF-H1100_'+sno}`; // Custom file name
