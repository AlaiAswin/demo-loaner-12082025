...
@Component({
  selector: 'app-bf-uc190f',
  templateUrl: './bf-uc190f.component.html',
  styleUrls: ['./bf-uc190f.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class BfUc190fComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR BF-UC190F', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['5', 'Endoscope connector', 'Connection of the endoscope and ultrasonic cable', `${s5}`],
                ['6', 'Image system', 'Inspection of the endoscopic image', `${s6}`],
                ['7', 'Ultrasound imaging system', 'Inspection of the ultrasonic image with the compact endoscopic ultrasound center', `${s7}`],
                ['8', 'Control section;\nSwitch section', 'Inspection of the remote switches', `${s8}`],
                ...
                ['11', 'alloon pipeline system', 'Inspection of the water feeding function into the balloon', `${s11}`],
                ['12', 'Instrument channel system', 'Inspection of the instrument channel', `${s12}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'BF-UC190F_' + sno}`; // Custom file name
