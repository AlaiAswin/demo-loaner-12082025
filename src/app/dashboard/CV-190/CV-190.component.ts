...
@Component({
  selector: 'app-CV-190',
  templateUrl: './CV-190.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Cv190Component {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR CV-190', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ['1', 'Cleaning/disinfection', 'Clean and disinfect the CV-190 according to the instructions described in the corresponding Instructions Manual.', `${s1}`],
              ...
              ['15', 'Power OFF', 'Press the power switch and verify that the CV-190 is turned off and the power indicator extinguishes', `${s15}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'CV-190 _' + sno}`; // Custom file name
