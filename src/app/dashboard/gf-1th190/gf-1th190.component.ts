...
@Component({
  selector: 'app-gf-1th190',
  templateUrl: './gf-1th190.component.html',
  styleUrls: ['./gf-1th190.component.css'],
  imports: [CommonModule, ReactiveFormsModule, FormsModule],
  standalone: true,
})
export class Gf1th190Component {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR GF-1TH190', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['15', 'Biopsy Channel', 'Inspection of the instrument channel', `${s15}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'GF-1TH190_' + sno}`; // Custom file name
