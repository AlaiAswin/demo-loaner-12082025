...
@Component({
  selector: 'app-ULTRASOUND_KEYBOARD',
  templateUrl: './ULTRASOUND_KEYBOARD.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Ultrasoundkeyboardcomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR ULTRASOUND KEYBOARD', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['2', 'KEYS', 'PROCEDURE PASSED', `${s2}`],
              ['3', 'TOUCH SCREEN  (If Applicable)', 'PROCEDURE PASSED', `${s3}`],
              ['4', 'CABLE ASSEMBLY', 'PROCEDURE PASSED', `${s4}`],
              ['5', 'CONNECTOR', 'PROCEDURE PASSED', `${s5}`],
