...
@Component({
  selector: 'app-FOOT_SWITCH',
  templateUrl: './FOOT_SWITCH.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Footswitchcomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR FOOT SWITCH', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['2', 'FOOT PADEL ', 'PROCEDURE PASSED', `${s2}`],
              ['3', 'FUNCTIONING', 'PROCEDURE PASSED', `${s3}`],
              ['4', 'CONNECTOR', 'PROCEDURE PASSED', `${s4}`],
              ['5', 'CABLE ASSEMBLY', 'PROCEDURE PASSED', `${s5}`],
