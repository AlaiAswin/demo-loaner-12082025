...
@Component({
  selector: 'app-bf-1t150',
  templateUrl: './bf-1t150.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Bf1t150Component {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR BF-1T150', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['3.2', 'Control section;\nAngle section', 'Inspection of the bending mechanisms:\n2. Inspection of the UP/DOWN/RIGHT/LEFT angulation mechanism', `${s3b}`],
                ...
                ['8', 'Suction System', 'Inspection of the suction function', `${s8}`],
                ['9', 'Instrument channel system', 'Inspection of the instrument channel', `${s9}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'BF-1T150_' + sno}`; // Custom file name
