...
@Component({
  selector: 'app-CLK-4',
  templateUrl: './CLK-4.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Clk4component {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR CLK-4', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ['1', 'Cleaning & Disinfection', 'Cleaning and disinfection of the CLK-4 must be performed according to the Instructions Manual.', `${s1}`],
              ['2', 'Power ON', 'Confirm that the lamp cover on the left side of the CLK-4 is closed completely.\nPress the power switch of CLK-4 to turn on the power.\nConfirm the following:\nThe green power switch indicator is illuminated.\nThe cooling fan motor starts operating.', `${s2}`],
              ['3', 'Air and water feeding', 'Turn on the air feeding switch, and confirm that a sound is heard. Turn off the switch and confirm that the sound stops.\nConnect the endoscope to CLK-4.\nImmerse the distal end of the endoscope in sterile water and turn on the air feeding \nswitch while operating the endoscope’s air feeding function.\nConfirm the following:\nConfirm that air bubbles are emitted from the nozzle of the distal end of the endoscope.\nRemove the distal end of the endoscope from the sterile water and operate the endoscope’s water feeding function.\nConfirm the following:\nConfirm that water is emitted from the nozzle of the distal end of the endoscope.', `${s3}`],
              ['4', 'Main Lamp', 'Connect the endoscope to CLK-4. Confirm the following:\nPress the power switch of the CLK-4 to turn on the power.\nConfirm that light is emitted from the distal end of the endoscope.\nPress the power switch of the CLK-4 to turn off the power.\nConfirm that light from the distal end of the endoscope goes out', `${s4}`],
              ['5', 'Brightness control', 'Press the power switch of the CLK-4 to turn on the power.\nVerify that the brightness can be adjusted properly.\nConfirm the following:\nConfirm that the brightness increases as you turn the brightness control knob clockwise.\nConfirm that the brightness decreases as you turn the brightness control knob counterclockwise.', `${s5}`],
              ['6', 'Turn off the power', ' Press the power switch of the CLK-4.\nConfirm that the power of the CLK-4 is turned off, and the power switch indicator goes out', `${s6}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'CLK-4_' + sno}`; // Custom file name
