...
@Component({
  selector: 'app-lft-s300-10-30',
  templateUrl: './lft-s300-10-30.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Lfts3001030Component {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR LTF-S300-10-3D', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ['5', 'Control section;\nswitch system', 'Inspection of the remote switches', `${s5}`],
              ['6', 'Insertion tube', 'Inspection of the insertion tube into the flexible trocar', `${s6}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'LTF-S300-10-3D_' + sno}`; // Custom file name
