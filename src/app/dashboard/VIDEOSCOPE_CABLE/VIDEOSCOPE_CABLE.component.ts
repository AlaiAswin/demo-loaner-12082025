...
@Component({
  selector: 'app-VIDEOSCOPE_CABLE',
  templateUrl: './VIDEOSCOPE_CABLE.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Videoscopecablecomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR VIDEOSCOPE CABLE', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['3', 'CONNECTOR CABLE', 'PROCEDURE PASSED', `${s3}`],
              ['4', 'CONDITION OF APPEARANCE', 'PROCEDURE PASSED', `${s4}`],
              ['5', 'ACCESSORIES', 'PROCEDURE PASSED', `${s5}`],
