...
@Component({
  selector: 'app-bf-mp190f',
  templateUrl: './bf-mp190f.component.html',
  styleUrls: ['./bf-mp190f.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class BfMp190fComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR BF-MP190F', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['4', 'Endoscope connector', 'Connection of ancillary equipment:\n1. Connection to the light source', `${s4}`],
                [
                  '5',
                  'Image system',
                  {
                        ...
                        canvas: [
                          {
                            ...
                            r1: 30, // horizontal radius of the circle
                            r2: 25, // vertical radius of the circle
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'BF-MP190F_' + sno}`; // Custom file name
