...
@Component({
  selector: 'app-cf-h190l',
  templateUrl: './cf-h190l.component.html',
  styleUrls: ['./cf-h190l.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class CfH190lComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR CF-H190L', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['18', 'Auxiliary water system', 'Inspection of the auxiliary water feeding function', `${s18}`],
              ],
            }
          }, function () {
            if (!image_data_url) {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'CF-H190L_' + sno}`; // Custom file name
