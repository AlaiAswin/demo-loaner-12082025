...
@Component({
  selector: 'app-cf-hq290zl',
  templateUrl: './cf-hq290zl.component.html',
  styleUrls: ['./cf-hq290zl.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class CfHq290zlComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR CF-HQ290ZL', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['15', 'Image system', 'Image system', `${s15}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'CF-HQ290ZL_' + sno}`; // Custom file name
