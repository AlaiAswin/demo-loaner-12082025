...
(pdfMake as any).vfs = pdfFonts.vfs;
@Component({
  selector: 'app-gc-uct140-al5',
  templateUrl: './gc-uct140-al5.component.html',
  styleUrls: ['./gc-uct140-al5.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class GcUCT140AL5Component {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR GF-UCT140-AL5', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['10', 'Endoscope connector', 'Connection of the videoscope cable', `${s10}`],
                ['11', 'Endoscope connector', 'Connection of the endoscope and ultrasonic cable', `${s11}`],
                ['12', 'Image system', 'Inspection of the endoscopic image', `${s12}`],
                ['13', 'Ultrasound imaging system', 'Inspection of the ultrasound image with the Olympus universal endoscopic ultrasound center EU-ME1', `${s13}`],
                ['14', 'Control section;\nSwitch system', 'Inspection of the remote switches', `${s14}`],
                ['15', 'Air supply system', 'Inspection of the air-feeding function', `${s15}`],
                ['16', 'Water supply system', 'Inspection of the objective lens cleaning function:\n1. Inspection of the water feeding function\n2. Inspection of removing the remaining water from the objective lens', `${s16}`],
                ['17', 'Balloon water supply system', 'Inspection of the water feeding function into the balloon', `${s17}`],
                ['18', 'Suction System', 'Inspection of the suction function', `${s18}`],
                ['19', 'Balloon water suction system', 'Inspection of aspiration from the balloon water suction port', `${s19}`],
                ['20', 'Instrument channel system;\nforceps elevator system', 'Inspection of the instrument channel and forceps elevator', `${s20}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'GF-UCT140-AL5_' + sno}`; // Custom file name
