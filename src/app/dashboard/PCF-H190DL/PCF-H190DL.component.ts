...
(pdfMake as any).vfs = pdfFonts;
@Component({
  selector: 'app-PCF-H190DL',
  templateUrl: './PCF-H190DL.component.html',
  styleUrls: ['./PCF-H190DL.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Pcfh190dlComponent {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR PCF-H190DL', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['13', 'Insertion section', 'Inspection of the endoscope position detecting function (UPD function check)', `${s13}`],
                ['14', 'Control section;\nSwitch system', 'Inspection of the remote switches', `${s14}`],
                ['15', 'Air supply system', 'Inspection of the air-feeding function:1. Confirmation of emitting no air bubbles\n2. Confirmation of emitting air bubbles', `${s15}`],
                ...
                ['17', 'Suction System', 'Inspection of the suction function', `${s17}`],
                ['18', 'Auxiliary water system', 'Inspection of the auxiliary water feeding function', `${s18}`],
                ['19', 'Instrument channel system', 'Inspection of the instrument channel', `${s19}`],
                ...(image_data_url === null ? [['', '', '', { text: '', pageBreak: 'before' }]] : []),
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'PCF-H190DL_' + sno}`; // Custom file name
