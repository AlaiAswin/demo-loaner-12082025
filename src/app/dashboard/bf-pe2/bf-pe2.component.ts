...
@Component({
  selector: 'app-bf-pe2',
  templateUrl: './bf-pe2.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class BfPE2Component {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR BF-PE2', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['6', 'Light guide connector', 'Inspection of the endoscopic image by attaching to light source', `${s6}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'BF-PE2_' + sno}`; // Custom file name
