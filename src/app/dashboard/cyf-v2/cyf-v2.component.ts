...
@Component({
  selector: 'app-cyf-v2',
  templateUrl: './cyf-v2.component.html',
  styleUrls: ['./cyf-v2.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Cyfv2Component {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR CYF-V2', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['6', 'Water supply system', 'Inspection of the irrigation function', `${s6}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'CYF-V2_' + sno}`; // Custom file name
