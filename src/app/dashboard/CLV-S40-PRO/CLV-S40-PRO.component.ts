...
@Component({
  selector: 'app-CLV-S40-PRO',
  templateUrl: './CLV-S40-PRO.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class CLVS40PROComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR CLV-S40-PRO', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ['1', 'Cleaning & Disinfection', 'Clean and disinfect the CLV-S40Pro according to the instructions in the corresponding Instructions Manual.', `${s1}`],
              ['2', 'Power ON', '\n-Verify that the air vents on the chassis and rear panel of the CLV-S40Pro are not clogged with dusts and/or foreign substances.\n-Verify that the lamp cover on the left side of the CLV-S40Pro is closed completely.\n-Press the power switch on the CLV-S40Pro with no endoscope connected.Inspect the following items:\n- The power indicator lights up.\n- The indicators on the control panel light up normally. If the indicators on the control panel blink, it is likely that the CLV-S40Pro is defective.\n-Press the power switch to turn OFF the CLV-S40Pro.\n-Connect an endoscope to the CLV-S40Pro and turn ON the CLV S40Pro.\n- Place a hand in front of the air vents on the rear panel.\n- Verify by feeling that the air is exhausted from the air vents.', `${s2}`],
              ...
              ['7', 'Manual brightness adjustment', 'Press the AUTO/MAN. brightness button to switch to“MAN.”\n- Press the brightness adjustment buttons (“ “ and “ ”).\nInspect the following items:\n- When either of the brightness buttons is pressed, a beep sounds and the brightness increases or decreases. The brightness level is indicated. \n- When either of the brightness adjustment buttons is pressed continuously, a beep sounds and the brightness indicator changes in a continuous manner.\n- The brightness of a light illuminated from the endoscope distal end increases or decreases accordingly.', `${s7}`],
              ['8', 'High intensity illumination mode', '-Connect the endoscope to the CLV-S40Pro. The connecting endscope must support high intensity function.\n-Press the AUTO/MAN. brightness button to switch to “MAN.”\n-Press the brightness adjustment button (“ “ or “ ”) to set the brightness level to 0.\n- Connect the endoscope to the CLV-S40Pro . The connecting endoscope must support high intensity illumination mode.\n-Press the HIGH button to set high intensity mode.\n- Verify that high intensity mode indicators lights up.\n-Verify that a light emitted from the distal end becomes brighter.\n- Press the HIGH button to release high intensity mode.\n-Verify that the high intensity mode button extinguishes.-Verify that the light illuminated from the distal end returns to the original illumination level.\n-Press the HIGH button again and verify that high intensity illumination mode is set.\n-Disconnect the endoscope from the CLV-S40Pro. Verify that the high intensity mode indicator remains lit.', `${s8}`],
              ['9', 'NBI observation function', '-Connect the endoscope to the CLV-180. The connecting endoscope must support the NBI observation function.\n- Inspect that the MODE button illuminates and the NBI indicator lights in green.\n- Press the MODE button.Inspect the following items:\n- The color of the light illuminated from the distal end changes to blue.\n- The color of the NBI indicator changes to white.', `${s9}`],
              ['10', 'Power OFF', '-Press the power switch on the CLV-S40Pro.\n- Verify that the CLV-S40Pro is turned off and the power indicator for the power switch extinguishes.', `${s10}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'CLV-S40-PRO_' + sno}`; // Custom file name
