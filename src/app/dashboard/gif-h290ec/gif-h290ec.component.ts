...
(pdfMake as any).vfs = pdfFonts;
@Component({
  selector: 'app-gif-h290ec',
  templateUrl: './gif-h290ec.component.html',
  styleUrls: ['./gif-h290ec.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Gifh290ecComponent {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR GIF-H290EC', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['11', 'Image system', 'Inspection of Zoom Function', `${s11}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'GIF-H290EC' + sno}`; // Custom file name
