...
@Component({
  selector: 'app-ULTRASOUND_PROBE',
  templateUrl: './ULTRASOUND_PROBE.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Ultrasoundprobecomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR ULTRASOUND PROBE', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['2', 'ULTRASOUND IMAGE', 'PROCEDURE PASSED', `${s2}`],
              ['3', 'APPEARENCE', 'PROCEDURE PASSED', `${s3}`],
