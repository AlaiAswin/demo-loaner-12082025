...
@Component({
  selector: 'app-cf-h290eci',
  templateUrl: './cf-h290eci.component.html',
  styleUrls: ['./cf-h290eci.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class CfH290eciComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        if ((s1 == p) && (s2 == p) && (s3 == p) && (s4 == p) && (s6a == p) && (s6b == p) && (s5 == p) && (s7 == p) && (s8 == p) && (s9 == p) && (s10 == p)
          && (s11 == p) && (s12 == p) && (s13 == p) && (s14 == p) && (s15 == p) && (s16 == p) && (s17a == p) && (s17b == p) && (s18 == p) && (s19 == p) && (s20 == p)) {
          console.log('Pass')
          overRes = 'Pass'
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR CF-H290ECI', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['13', 'Image system', 'Inspection of the Zoom function', `${s13}`],
                ['14', 'Image system', 'Inspection of the Resolution (Ultra-high magnification observation)', `${s14}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'CF-H290ECI_' + sno}`; // Custom file name
