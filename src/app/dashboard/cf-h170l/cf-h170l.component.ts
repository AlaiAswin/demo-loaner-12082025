...
@Component({
  selector: 'app-cf-h170l',
  templateUrl: './cf-h170l.component.html',
  styleUrls: ['./cf-h170l.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class CfH170lComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        if ((s1 == p) && (s2 == p) && (s3 == p) && (s4 == p) && (s5a == p) && (s5b == p) && (s6 == p) && (s7 == p) && (s8 == p) && (s9 == p) && (s10 == p)
          && (s11 == p) && (s12 == p) && (s13 == p) && (s14a == p) && (s14b == p) && (s15 == p) && (s16 == p) && (s17 == p)) {
          console.log('Pass')
          overRes = 'Pass'
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR CF-H170L', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['9', 'Endoscope connector', 'Connection to the light source and video system', `${s9}`],
                ['10', 'Endoscope connector', 'Connection of the water container', `${s10}`],
                ['11', 'Image system', 'Inspection of the endoscopic image', `${s11}`],
                ['12', 'Control section;\nSwitch section', 'Inspection of the remote switches', `${s12}`],
                ['13', 'Air supply system', 'Inspection of the air-feeding function', `${s13}`],
                ['14.1', 'Water supply system', 'Inspection of the objective lens cleaning function:\n1. Inspection of the water feeding function', `${s14a}`],
                ['14.2', 'Water supply system', 'Inspection of the objective lens cleaning function:\n2. Inspection of removing the remaining water from the objective lens', `${s14b}`],
                ['15', 'Suction System', 'Inspection of the suction function', `${s15}`],
                ['16', 'Auxiliary water system', 'Inspection of the auxiliary water feeding function', `${s16}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'CF-H170L_' + sno}`; // Custom file name
