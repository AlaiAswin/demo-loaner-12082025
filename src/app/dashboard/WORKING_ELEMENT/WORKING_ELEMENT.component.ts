...
@Component({
  selector: 'app-WORKING_ELEMENT',
  templateUrl: './WORKING_ELEMENT.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Workingelementcomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'Asset Inspection Card - WORKING ELEMENT', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
            ...
            body: [
              ...
              [
                { text: 'PRODUCT NAME', fillColor: '#CCCCCC', alignment: 'center' },
