...
(pdfMake as any).vfs = pdfFonts;
@Component({
  selector: 'app-gif-hq290',
  templateUrl: './gif-hq290.component.html',
  styleUrls: ['./gif-hq290.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Gifhq290Component {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR GIF-HQ290', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['11', 'Image system', 'Inspection of the focus switching function:\n1. Inspection of switching to the near focus mode\n2. Inspection of switching to the normal focus mode', `${s11}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'GIF-HQ290' + sno}`; // Custom file name
