...
(pdfMake as any).vfs = pdfFonts.vfs;
@Component({
  selector: 'app-PCF-PH190L',
  templateUrl: './PCF-PH190L.component.html',
  styleUrls: ['./PCF-PH190L.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Pcfph190lComponent {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR PCF-PH190L', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['10', 'Insertion section', 'Inspection of the passive bending section', `${s10}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'PCF-PH190L_' + sno}`; // Custom file name
