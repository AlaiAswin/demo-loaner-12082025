...
//50
  ...
  {path: 'OTV-S500', loadComponent:()=>import('./OTV-S500/OTV-S500.component').then(m => m.Otvs500Component)},// new added
  {path: 'GIF-XZ1200', loadComponent:()=>import('./gif-xz1200/gif-xz1200.component').then(m => m.Gifxz1200Component)}
