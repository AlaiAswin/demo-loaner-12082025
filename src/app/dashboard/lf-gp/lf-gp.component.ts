...
@Component({
  selector: 'app-lf-gp',
  templateUrl: './lf-gp.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class LfgpComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR LF-GP', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['7', 'Water supply system', 'Inspection of the water feed function', `${s7}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'LF-GP_' + sno}`; // Custom file name
