...
@Component({
  selector: 'app-OTV-S7PROH-HD-10E',
  templateUrl: './OTV-S7PROH-HD-10E.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Otvs7prohhd10ecomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR OTV-S7PROH-HD-10E', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ['1', 'Cleaning & Disinfection', 'Cleaning and disinfection of the OTV-S7PROH-HD-10E must be performed according to the Instructions Manual.', `${s1}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'OTV-S7PROH-HD-10E_' + sno}`; // Custom file name
