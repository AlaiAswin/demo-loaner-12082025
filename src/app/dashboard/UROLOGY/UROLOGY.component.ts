  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'Asset Inspection Card - UROLOGY', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
...

        {
          table: {
            ...
            body: [
              ...
              ['5', 'ALBARAN BRIDGE', 'PROCEDURE PASSED ', `${s5}`],
              ['6', 'STOPCOCK', ' PROCEDURE PASSED ', `${s6}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'UROLOGY_' + sno}`; // Custom file name
