...
(pdfMake as any).vfs = pdfFonts.vfs;
@Component({
  selector: 'app-TJF-Q160VR',
  templateUrl: './TJF-Q160VR.component.html',
  styleUrls: ['./TJF-Q160VR.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Tjfq160vrComponent {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR TJF-160VR', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
            ...
            table: {
              ...
              body: [
                ...
                ['17', 'Instrument channel system', 'Inspection of the instrument channel and forcep elevator', `${s17}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'TJF-Q160VR_' + sno}`; // Custom file name
