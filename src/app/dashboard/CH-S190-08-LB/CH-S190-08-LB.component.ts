...
@Component({
  selector: 'app-CH-S190-08-LB',
  templateUrl: './CH-S190-08-LB.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Chs19008lbcomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR CH-S190-08-LB', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ['3', 'Connection of the camera head and ancillary equipment (Connection to the endoscope)', '1 Hold the endoscope mount with one hand and press both endoscope lock buttons.\n2 While keeping the endoscope lock buttons pressed, press the eyepiece of the endoscope gently into the endoscope mount then release the endoscope lock button.', `${s3}`],
      ...
      if (image_data_url) {
        content.unshift(
          { text: 'Issue date : 27 July 2018', alignment: 'right', fontSize: 5, }, { text: 'REV NO : 02', alignment: 'right', fontSize: 5 },
          {
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'CH-S190-08-LB_' + sno}`; // Custom file name
