...
@Component({
  selector: 'app-cyf-vh',
  templateUrl: './cyf-vh.component.html',
  styleUrls: ['./cyf-vh.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class CyfvhComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR CYF-VH', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['7', 'Instrument channel System', 'Inspection of the instrument channel', `${s7}`],
              ],
            }
          },
          {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'CYF-VH_' + sno}`; // Custom file name
