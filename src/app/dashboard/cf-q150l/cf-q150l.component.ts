...
@Component({
  selector: 'app-cf-q150l',
  templateUrl: './cf-q150l.component.html',
  styleUrls: ['./cf-q150l.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class CfQ150lComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        if ((s1 == p) && (s2 == p) && (s3 == p) && (s4 == p) && (s5a == p) && (s5b == p) && (s6 == p) && (s7 == p) && (s8 == p) && (s9 == p) && (s10 == p)
          && (s11 == p) && (s12 == p) && (s13 == p) && (s14 == p) && (s15a == p) && (s15b == p) && (s16 == p) && (s17 == p)) {
          console.log('Pass')
          overRes = 'Pass'
        ...
        var content: Content[] = [
          ...
          { text: 'DEMO-LOANER INSPECTION SHEET FOR CF-Q150L', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ['5.2', 'Control section;\nAngle section', 'Inspection of the bending mechanisms:\n2. Inspection of the UP/DOWN and RIGHT/LEFT angulation mechanism', `${s5b}`],
                ...
                ['17', 'Instrument channel system', 'Inspection of the instrument channel', `${s17}`],
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'CF-Q150L_' + sno}`; // Custom file name
