...
@Component({
  selector: 'app-CH-S190-XZ-E',
  templateUrl: './CH-S190-XZ-E.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Chs190xzecomponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR CH-S190-XZ-E', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ['2', 'Connection to the video system center', '1. If any ancillary equipment is ON, turn it OFF.\n2. Confirm that the video connector and its electrical contacts are dry.\n3. Make sure that the UP mark on the video connector is facing up.\n4. Hold the video system center stationary with one hand. With the other hand,push the video connector into the video connector socket until it clicks.\n5.Confirm that the video connector is securely attached by pulling it gently', `${s2}`],
              ['3', 'Connection of the camera head and ancillary equipment(Connection to the endoscope)', '1. Hold the camera head.\n2. Attach the endoscope’s eyepiece to the endoscope mount while sliding the endoscope lock in the direction of the arrow.\n3.Release the endoscope lock to secure the eyepiece in the specified position.', `${s3}`],
              ['4', 'Inspection of the endoscopic image', '1.Turn ON the video system center, the light source, and the monitor.\n2.Observe the palm of your hand in the WLI and NBI endoscopic images.\n3.Confirm that the illumination light is emitted and that the WLI and NBI endoscopic images are free from noise, blur, fog, or other irregularities.\n4.Shake the camera cable and confirm that the endoscopic image does notmomentarily disappear, flicker, or display any other irregularities.', `${s4}`],
              ['5', 'Inspection of the remote switches', '1.Turn ON the video system center, the light source, and the monitor.\n2. Observe the palm of your hand in the WLI and NBI endoscopic images.\n3.Confirm that the illumination light is emitted and that the WLI and NBI endoscopic images are free from noise, blur, fog, or other irregularities.\n4.Shake the camera cable and confirm that the endoscopic image does not momentarily disappear, flicker, or display any other irregularities.', `${s5}`],
              ...
              ['7', 'Inspection of the focus and zoom control', 'Press every focus control switch and zoom control switch and confirm that they work properly.', `${s7}`]
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'CH-S190-XZ-E_' + sno}`; // Custom file name
