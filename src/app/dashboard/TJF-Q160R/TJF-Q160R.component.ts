...
(pdfMake as any).vfs = pdfFonts.vfs;
@Component({
  selector: 'app-TJF-Q160R',
  templateUrl: './TJF-Q160R.component.html',
  styleUrls: ['./TJF-Q160R.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Tjfq160rComponent {
  formGroup: any;
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  async download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      if (proceed == 'true') {
        ...
        var content: Content[] = [
          { text: 'DEMO-LOANER INSPECTION SHEET FOR TJF-160R', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
          {
            table: {
        ...
        pdfDocGenerator.getBlob((blob) => {
          const fileName = `${'TJF-Q160R_' + sno}`; // Custom file name
