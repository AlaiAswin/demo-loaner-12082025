...
@Component({
  selector: 'app-CH-S200-08-LB',
  templateUrl: './CH-S200-08-LB.component.html',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  standalone: true
})
export class Chs20008lbComponent {
  startTime: any;
  endTime: any;
  cdsDate: any;
  ...
  download() {
    ...
    if (this.formGroup.status == 'INVALID') {
      ...
      var content: Content[] = [
        ...
        { text: 'DEMO-LOANER INSPECTION SHEET FOR CH-S200-08-LB', alignment: 'center', margin: [0, 10, 0, 5], bold: true, fontSize: 16 },
        {
          table: {
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ['1', 'Cleaning & Disinfection', 'Clean and disinfect the CH-S200-08-LB according to the instructions in the corresponding Instructions Manual.', `${s1}`],
      ...
      pdfDocGenerator.getBlob((blob) => {
        const fileName = `${'CH-S200-08-LB_' + sno}`; // Custom file name
